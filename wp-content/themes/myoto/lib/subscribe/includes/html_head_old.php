...
<style type="text/css" media="all">
  ...
  #main1 {padding: 20px;}
  #subscriber_tools {color: #325b61; font-size: 18px; font-weight: bold;}
  #tools_table {width: 100%;}
  #subscribe_table {width: 100%;}
  #tools_table a {color: #272425; font-size: 18px; text-decoration: none;}
  #tools_table .red_arrows {color: #b0282e;}
  #tools_table a:hover {color: #b0282e;}
