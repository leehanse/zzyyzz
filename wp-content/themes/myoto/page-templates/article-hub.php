<?php
/**
 * Template Name: Article Hub Template
 */
?>
<?php get_header(); ?> 
    <div class="content clearfix">
    	<div class="panelLeft">
            <?php
                $article_category_id     = get_queried_object()->term_id;    
                $article_category_slug   = get_queried_object()->slug;
            ?>            
            <?php if(is_tax('article-category')): ?>
            <section>
