...
<?php get_header(); ?> 
    <div class="content clearfix">
        <input type="hidden" id="PAGE" value="Events-futured_event_s"/>
    	<div class="panelLeft">
            <style>
                ul#tabnav {
            ...
            <section>
            	<ul class="breadcrumb">
                    ...
                    <li><span>Featured Events</span></li>
                </ul>
            </section>            
            <?php
            ...
            <!--
            <ul id="tabnav">
                <li class="tab1"><a <?php if($type == 'featured'):?> class="active" <?php endif;?> href="<?php echo add_query_arg(array("type"=>"featured"),  get_permalink()); ?>">Featured Events</a></li>
                <li class="tab2"><a <?php if($type == 'normal'):?> class="active" <?php endif;?> href="<?php echo add_query_arg(array("type"=>"normal"),  get_permalink());?>">Normal Events</a></li>                
            </ul>            
            -->
                        ...
                        <div class="details">                             
                            ...
                            <section class="widget" style="background:none !important;padding-bottom:0px !important;margin-bottom:0px !important;">
                                <div id='articleSlider<?php echo get_the_ID();?>' class='swipe'>
                                    ...
                                    <div class="control">
                                        <div onclick='futured_event_Swipe<?php echo get_the_ID();?>.prev()' class="controlPrev">prev</div>
                                        <ul class="position" id="futured_event_Position<?php echo get_the_ID();?>">
                                        ...
                                        <div onclick='futured_event_Swipe<?php echo get_the_ID();?>.next()' class="controlNext">next</div>
                                    </div>
                                </div>
                            </section> 
                            <script>
                                // pure JS
                                var futured_event_bullets<?php echo get_the_ID();?> = document.getElementById('futured_event_Position<?php echo get_the_ID();?>').getElementsByTagName('li');
                                var elem<?php echo get_the_ID();?> = document.getElementById('articleSlider<?php echo get_the_ID();?>');
                                window.futured_event_Swipe<?php echo get_the_ID();?> = Swipe(elem<?php echo get_the_ID();?>, {
                                    //startSlide: 4,
                                    //auto: 3000,
                                    continuous: false,
                                    disableScroll: false,
                                    ...
                                    callback: function(pos) {
                                        var i = futured_event_bullets<?php echo get_the_ID();?>.length;
                                        while (i--) {
                                            futured_event_bullets<?php echo get_the_ID();?>[i].className = ' ';
                                        }
                                        futured_event_bullets<?php echo get_the_ID();?>[pos].className = 'on';                        
                                    }
                                });
                                $('#futured_event_Position<?php echo get_the_ID();?> li').click(function() {
                                        idx=( $(this).index() );
                                        futured_event_Swipe<?php echo get_the_ID();?>.slide(idx, 800);
                                });
                                // with jQuery
                                //window.articleSwipe = $('#articleSlider<?php echo get_the_ID();?>').Swipe().data('Swipe');
                            </script>                                
                            <?php else:?>                            
                                <div class="thumb-wrapper">
                                    <div class="thumb">
                                        <a href="<?php the_permalink();?>">
                                            ...
                                            <?php else:?>
                                                <?php custom_post_thumbnail(null);?>
                                            <?php endif;?>
                                        </a>
                                    </div>
                                </div>                                                                                    
