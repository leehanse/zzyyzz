<?php
  ...
  /* 'SubType' => array('type' => 'radio',
                                      ...
                                      'email' => FALSE,
                                      'options' => array ( 'S1'=>'&nbsp; One year (6 issues) - $18.00 (Int\'l. $38.00) - Save 40% off the cover price',
                                                           'S2'=>'&nbsp; Two years (12 issues) - $29.00 (Int\'l. $69.00) - Save 49% - Best Value!',
                                                           ),
                                      'email' => TRUE,
                                        ),
 */
                '1_ShiptoFirstName' => array('type' => 'text',
                                      'label' => 'First Name',
                                      'text' => '<br /><span class="gift_num">1</span><span class="gift_price">SEND GIFT 1 FOR $18 TO:        </span>',
                                      'value' => '',
                                      'required' => TRUE,
                                      'email' => TRUE,
...
//Gift 2
                '2_ShiptoFirstName' => array('type' => 'text',
                                      'label' => 'First Name',
                                      'text' => '<br /><span class="gift_num">2</span><span class="gift_price">SEND GIFT 2 FOR $18 TO:</span>',
                                      'value' => '',
                                      'required' => TRUE,
                                      'email' => TRUE,
                                      'parm' => 'class="sub_field"',
...
// GIFT 3
                '3_ShiptoFirstName' => array('type' => 'text',
                                      'label' => 'First Name',
                                      'text' => '<br /><span class="gift_num">3</span><span class="gift_price">SEND GIFT 3 FOR $18 TO:</span>',
                                      'value' => '',
                                      'required' => TRUE,
                                      'email' => TRUE,
                                      'parm' => 'class="sub_field"',
...
//GIFT 4
                '4_ShiptoFirstName' => array('type' => 'text',
                                      'label' => 'First Name',
                                      'text' => '<br /><span class="gift_num">4</span><span class="gift_price">SEND GIFT 4 FOR $18 TO:</span>',
                                      'value' => '',
                                      'required' => TRUE,
                                      'email' => TRUE,
                                      'parm' => 'class="sub_field"',
...
// GIFT 5
                '5_ShiptoFirstName' => array('type' => 'text',
                                      'label' => 'First Name',
                                      'text' => '<br /><span class="gift_num">5</span><span class="gift_price">SEND GIFT 5 FOR $18 TO:</span>',
                                      'value' => '',
                                      'required' => TRUE,
                                      'email' => TRUE,
                                      'parm' => 'class="sub_field"',
...
//GIFT 6
                '6_ShiptoFirstName' => array('type' => 'text',
                                      'label' => 'First Name',
                                      'text' => '<br /><span class="gift_num">6</span><span class="gift_price">SEND GIFT 6 FOR $18 TO:</span>',
                                      'value' => '',
                                      'required' => TRUE,
                                      'email' => TRUE,
                                      'parm' => 'class="sub_field"',
...
// BILLING
                'FirstName' => array('type' => 'text',
                                      'text' => '<br /><span class="billing_info_line">BILLING INFORMATION:</span>',
                                      'label' => 'First Name',
                                      'value' => '',
                                      'required' => TRUE,
                                      'email' => TRUE,
