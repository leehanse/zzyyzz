        ...
        <div class="row">
            <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12 first clearfix">
                <div class="widget cats_widget clearfix">
                    <div class="title">
                        <h3><i class="icon-sale"></i> For Sale</h3>
                    </div>
                ...
                <div class="widget clearfix">
                    <div class="title">
                        <h3><i class="icon-rent"></i> For Rent</h3>
                    </div>
                    <ul class="real-estate-cats-widget" data-effect="slide-left">
                        <li>
                            <a href="#">Housing (15)</a>
            ...
            <div class="col-lg-7 col-md-9 col-sm-9 col-xs-12 clearfix">
                <div id="tabbed_widget" class="tabbable clearfix">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#tab" data-toggle="tab">Hà Nội</a></li>
                        <li><a href="#tab2" data-toggle="tab">Tp. HCM</a></li>
                        <li><a href="#tab3" data-toggle="tab">Đà Nẵng</a></li>
                        <li><a href="#tab4" data-toggle="tab">Cần Thơ</a></li>
                        <li><a href="#tab5" data-toggle="tab">Hải Phòng</a></li>
                    </ul>
                        ...
                        <div class="tab-pane active" id="tab">
                                ...
                                <div class="boxes">
                                    <div class="boxes_img ImageWrapper">
                                        <a href="single-property.html">
                                            <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/demos/01_home.jpg" alt="">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="boxes">
                                    <div class="boxes_img ImageWrapper">
                                        <a href="single-property.html">
                                            <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/demos/02_home.jpg" alt="">
                                            <div class="PStyleNe"></div>
                                        </a>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 last">
                                <div class="boxes">
                                    <div class="boxes_img ImageWrapper">
                                        <a href="single-property.html">
                                            <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/demos/03_home.jpg" alt="">
                                            <div class="PStyleNe"></div>
                                        </a>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 first">
                                <div class="boxes">
                                    <div class="boxes_img ImageWrapper">
                                        <a href="single-property.html">
                                            <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/demos/04_home.jpg" alt="">
                                            <div class="PStyleNe"></div>
                                        </a>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="boxes">
                                    <div class="boxes_img ImageWrapper">
                                        <a href="single-property.html">
                                            <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/demos/05_home.png" alt="">
                                            <div class="PStyleNe"></div>
                                        </a>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 last">
                                <div class="boxes">
                                    <div class="boxes_img ImageWrapper">
                                        <a href="single-property.html">
                                            <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/demos/06_home.png" alt="">
                                            <div class="PStyleNe"></div>
                                        </a>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 first">
                                <div class="boxes">
                                    <div class="boxes_img ImageWrapper">
                                        <a href="single-property.html">
                                            <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/demos/07_home.png" alt="">
                                            <div class="PStyleNe"></div>
                                        </a>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="boxes">
                                    <div class="boxes_img ImageWrapper">
                                        <a href="single-property.html">
                                            <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/demos/08_home.png" alt="">
                                            <div class="PStyleNe"></div>
                                        </a>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 last">
                                <div class="boxes">
                                    <div class="boxes_img ImageWrapper">
                                        <a href="single-property.html">
                                            <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/demos/09_home.png" alt="">
                                            <div class="PStyleNe"></div>
                                        </a>
            ...
            <div class="col-lg-3 col-md-6 col-sm-9 col-xs-12 last clearfix">
                <div class="widget clearfix">
                    <div class="agents_widget">
                        <div class="title">
                            <h3><i class="fa fa-users"></i> Our Agents</h3>
                        </div>
                        <div class="agent boxes clearfix" data-effect="slide-right">
                            <div class="image">
                                <img class="img-circle img-responsive img-thumbnail" src="<?php echo get_template_directory_uri(); ?>/demos/01_team.png" alt="">
                            </div>
                            <!-- image -->
                        ...
                        <div class="agent boxes clearfix" data-effect="slide-right">
                            <div class="image">
                                <img class="img-circle img-responsive img-thumbnail" src="<?php echo get_template_directory_uri(); ?>/demos/02_team.png" alt="">
                            </div>
                            <!-- image -->
                            <div class="agent_desc">
                        ...
                        <div class="agent boxes clearfix" data-effect="slide-right">
                            <div class="image">
                                <img class="img-circle img-responsive img-thumbnail" src="<?php echo get_template_directory_uri(); ?>/demos/03_team.png" alt="">
                            </div>
                            <!-- image -->
                            <div class="agent_desc">
                        ...
                        <div class="agent boxes clearfix" data-effect="slide-right">
                            <div class="image">
                                <img class="img-circle img-responsive img-thumbnail" src="<?php echo get_template_directory_uri(); ?>/demos/04_team.png" alt="">
                            </div>
                            <!-- image -->
                            <div class="agent_desc">
                    ...
                    <!-- end of agents_widget -->
                </div>
                <!-- end of widget -->
                <div class="widget text-center clearfix">
                    <img data-effect="fade" class="img-thumbnail img-responsive" src="<?php echo get_template_directory_uri(); ?>/demos/01_banner.png" alt="">
                </div>
                <!-- end of widget -->  
            </div>
            <!-- end col-lg-4 --> 
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="boxes testimonial_widget text-right first" data-effect="slide-left">
                            <div class="image">
                                <img class="img-circle img-responsive img-thumbnail" alt="" src="<?php echo get_template_directory_uri(); ?>/demos/03_team.png">
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="boxes testimonial_widget text-left last" data-effect="slide-right">
                            <div class="image">
                                <img class="img-circle img-responsive img-thumbnail" alt="" src="<?php echo get_template_directory_uri(); ?>/demos/02_team.png">
                            </div>
                            <div class="testimonial_desc">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="boxes testimonial_widget text-right first" data-effect="slide-left">
                            <div class="image">
                                <img class="img-circle img-responsive img-thumbnail" alt="" src="<?php echo get_template_directory_uri(); ?>/demos/04_team.png">
                            </div>
                            <div class="testimonial_desc">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="boxes testimonial_widget text-left last" data-effect="slide-right">
                            <div class="image">
                                <img class="img-circle img-responsive img-thumbnail" alt="" src="<?php echo get_template_directory_uri(); ?>/demos/01_team.png">
                            </div>
                            <div class="testimonial_desc">
                ...
                <div id="slider" class="flexslider">
                    <ul class="slides">
                        <li>
                            ...
                            <img class="img-thumbnail" src="<?php echo get_template_directory_uri(); ?>/demos/01_home.jpg" alt="">
                        </li>
                        <li>
                            <div class="ps-mini-desc">
                            ...
                            <img class="img-thumbnail" src="<?php echo get_template_directory_uri(); ?>/demos/02_home.jpg" alt="">
                        </li>
                        <li>
                            <div class="ps-mini-desc">
                            ...
                            <img class="img-thumbnail" src="<?php echo get_template_directory_uri(); ?>/demos/03_home.jpg" alt="">
                        </li>
                        <li>
                            <div class="ps-mini-desc">
                                <span class="type">Family Home</span>
                            ...
                            <img class="img-thumbnail" src="<?php echo get_template_directory_uri(); ?>/demos/04_home.jpg" alt="">
                        </li>
                        <li>
                            <div class="ps-mini-desc">
                            ...
                            <img class="img-thumbnail" src="<?php echo get_template_directory_uri(); ?>/demos/05_home.png" alt="">
                        </li>
                        <li>
                            <div class="ps-mini-desc">
                                <span class="type">Family Home</span>
                            ...
                            <img class="img-thumbnail" src="<?php echo get_template_directory_uri(); ?>/demos/06_home.png" alt="">
                        </li>
                        <li>
                            <div class="ps-mini-desc">
                            ...
                            <img class="img-thumbnail" src="<?php echo get_template_directory_uri(); ?>/demos/07_home.png" alt="">
                        </li>
                        <li>
                            <div class="ps-mini-desc">
                                <span class="type">Apertment</span>
                            ...
                            <img class="img-thumbnail" src="<?php echo get_template_directory_uri(); ?>/demos/08_home.png" alt="">
                        </li>
                    </ul>
                </div>
                <div id="carousel" class="flexslider">
                    <ul class="slides">
                        <li><img class="img-thumbnail" src="<?php echo get_template_directory_uri(); ?>/demos/01_home.jpg" alt=""></li>
                        <li><img class="img-thumbnail" src="<?php echo get_template_directory_uri(); ?>/demos/02_home.jpg" alt=""></li>
                        <li><img class="img-thumbnail" src="<?php echo get_template_directory_uri(); ?>/demos/03_home.jpg" alt=""></li>
                        <li><img class="img-thumbnail" src="<?php echo get_template_directory_uri(); ?>/demos/04_home.jpg" alt=""></li>
                        <li><img class="img-thumbnail" src="<?php echo get_template_directory_uri(); ?>/demos/05_home.png" alt=""></li>
                        <li><img class="img-thumbnail" src="<?php echo get_template_directory_uri(); ?>/demos/06_home.png" alt=""></li>
                        <li><img class="img-thumbnail" src="<?php echo get_template_directory_uri(); ?>/demos/07_home.png" alt=""></li>
                        <li><img class="img-thumbnail" src="<?php echo get_template_directory_uri(); ?>/demos/08_home.png" alt=""></li>
                    </ul>
                </div>
            </div>
            <!-- end col6 -->
...
<!-- end secondwrapper -->
<section id="four-parallax" class="parallax">
    <div class="overlay1 dm-shadow">
        <div class="container">
            <div class="row">
                <div class="text-center clearfix">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="boxes agencies_widget first" data-effect="slide-bottom">
                        <div class="col-lg-3">
                            <div class="image">
                                <img class="img-responsive img-thumbnail" src="<?php echo get_template_directory_uri(); ?>/demos/agencies_logo.png" alt="">
                            </div>
                            <!-- end agencies img -->
                        </div>
                        <div class="col-lg-9">
