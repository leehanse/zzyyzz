<?php
/**
 * Template Name: Upgrade Print To Digital
 */
?>
<?php 
  ...
  if(isset($_POST['action']) && $_POST['action'] == 'find'){    
    ...
    try{
        ...
        if($subscribe_page){
            ...
            $subscribe_url = add_query_arg(array('action'=>'fill','promo'=>'upgrade-digital','sn'=>$row->SubscriptionNum,'SourceCode'=>'Web'),$subscribe_url);
    ...
    <div class="panelCenter">
        ...
        <section>
            <ul class="breadcrumb">
                ...
                <li><span>Upgrade Print Subscription To Digital Subscription</span></li>
            </ul>
        </section>
        <?php 
        ...
        <section class="Drinkup">
                ...
                <div class="right">
                    <h1 style="padding-top:0px;margin-top: 0px;">Upgrade Instructions</h1>
                    ...
                    ?>
                    <form method="post" id="upgrade_print_to_digital_form" action="<?php echo add_query_arg(array('page_id' =>  get_the_ID(),'promo'=>$promo,'SourceCode'=>$source));?>">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
               $("#upgrade_print_to_digital_form input[type='text']").keyup(function( event ) {
                    if ( event.which == 13 ) {    
                        submitFormProcess();
                    }
               });
            ...
            function submitFormProcess(){
                ...
                if(check_form) $("#upgrade_print_to_digital_form").submit();
